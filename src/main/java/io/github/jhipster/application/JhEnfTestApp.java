...
public class JhEnfTestApp {

    private static final Logger log = LoggerFactory.getLogger(JhEnfTestApp.class);

    private final Environment env;

    public JhEnfTestApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes jhEnfTest.
     * <p>
    ...
    public static void main(String[] args) {
        SpringApplication app = new SpringApplication(JhEnfTestApp.class);
